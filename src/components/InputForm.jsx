...
// 学校列表
const schools = [
  { id: "Kolping-Bildungswerk in der Diözese Rgb.e.V. (Weiden in der Oberpfalz)", name: "Kolping-Bildungswerk in der Diözese Rgb.e.V. (Weiden in der Oberpfalz)", country: "USA", logo: "/Kolping-Bildungswerk.png },
