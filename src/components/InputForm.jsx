...
const schools = [
  {
    id: "kolping",
    name: "Kolping-Bildungswerk in der Diözese Rgb.e.V. (Weiden in der Oberpfalz)",
    country: "USA",
  ...
  { id: "Royal", name: "OHLA Schools Miami, FL", country: "USA", logo: "/Royal.png" },
  { id: "osaka", name: "Huntington Beach Adult School (Huntington Beach, CA)", country: "Japan", logo: "/osaka-university.svg" },
  { id: "waseda", name: "Orange Coast College (Costa Mesa, CA)", country: "Japan", logo: "/waseda-university.svg" },
  { id: "keio", name: "Kevo University (Oklahoma, OK)", country: "Japan", logo: "/logo.png" },
  { id: "hokkaido", name: "Mt San Jacinto Community College District (San Jacinto, CA)", country: "Japan", logo: "/logo.png" },
